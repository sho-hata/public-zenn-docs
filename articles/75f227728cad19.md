...
これは[Go Advent Calendar 2025](https://qiita.com/advent-calendar/2025/go)、[カンムアドベントカレンダー2025](https://adventar.org/calendars/12074)の8日目の裏テーマ記事です。
...
flowchart TD
    A[
      ...
      ・引数が指定されていなかった場合に「./...」をデフォルトで指定
     ] --> B[
      golang.org/x/tools/go/packages
			
      ・ドライバ（golang/go/internal/list）にパターンを委譲
      ・ドライバ処理の結果をPackage オブジェクトに変換・最適化
     ]
    B --> C[
      golang/go
